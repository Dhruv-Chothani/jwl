...
export function AboutPage() {
  return (
    <SiteLayout>
      <Helmet>
        <title>The Atelier — Maison Lumière</title>
        <meta name="description" content="Four generations of Parisian jewelers crafting heirloom pieces by hand on Rue de la Paix." />
        <meta property="og:title" content="The Atelier — Maison Lumière" />
        <meta property="og:image" content={atelier} />
      </Helmet>
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-10 grid lg:grid-cols-2 gap-16 items-center">
        <img src={atelier} alt="Master jeweler at work" loading="lazy" className="aspect-[7/5] w-full object-cover shadow-luxe" />
        <div>
