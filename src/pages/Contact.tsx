...
export function ContactPage() {
  ...
  return (
    <SiteLayout>
      <Helmet>
        <title>Contact & Private Appointments — Maison Lumière</title>
        <meta name="description" content="Visit our Paris atelier or book a private viewing with our concierge." />
      </Helmet>
      <Toaster />
      <section className="mx-auto max-w-7xl px-6 py-24 md:px-10 md:py-32 grid gap-16 lg:grid-cols-2">
        ...
        <form onSubmit={onSubmit} className="bg-secondary/60 p-8 md:p-12 space-y-6">
          <div>
            ...
            <input required name="name" className="mt-3 w-full bg-transparent border-b border-foreground/30 py-3 text-base focus:border-gold focus:outline-none" />
          </div>
          <div>
            <label className="eyebrow">Email</label>
            <input required type="email" name="email" className="mt-3 w-full bg-transparent border-b border-foreground/30 py-3 text-base focus:border-gold focus:outline-none" />
          </div>
          <div>
            <label className="eyebrow">Interest</label>
            <select name="interest" className="mt-3 w-full bg-transparent border-b border-foreground/30 py-3 text-base focus:border-gold focus:outline-none">
          ...
          <div>
            ...
            <textarea name="message" rows={4} className="mt-3 w-full bg-transparent border-b border-foreground/30 py-3 text-base focus:border-gold focus:outline-none resize-none" />
          </div>
          <button type="submit" disabled={sending} className="bg-onyx text-ivory px-10 py-4 text-xs tracking-[0.3em] uppercase hover:bg-gold-deep transition-colors disabled:opacity-60">
