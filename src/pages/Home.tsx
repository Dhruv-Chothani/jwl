...
export function HomePage() {
  return (
    <SiteLayout>
      <Helmet>
        <title>Maison Lumière — Fine Jewelry Handcrafted in Paris</title>
        <meta name="description" content="A century of Parisian craftsmanship. Discover diamond, gold and emerald pieces handmade in our atelier." />
        <meta property="og:title" content="Maison Lumière — Fine Jewelry" />
        <meta property="og:description" content="Heirloom jewelry, hand-finished in Paris since 1924." />
      </Helmet>

      <section className="relative h-[88vh] min-h-[640px] w-full overflow-hidden bg-onyx">
        <img src={hero} alt="Diamond necklace on model" className="absolute inset-0 h-full w-full object-cover opacity-90" />
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-20 md:px-10 md:pb-28">
          <div className="max-w-2xl animate-fade-up">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link to="/collections" className="group inline-flex items-center gap-3 bg-ivory px-8 py-4 text-xs tracking-[0.25em] text-onyx uppercase transition-all hover:bg-gold-soft">
                Explore Collections
                <span className="transition-transform group-hover:translate-x-1">→</span>
              </Link>
              <Link to="/about" className="px-2 py-4 text-xs tracking-[0.25em] text-ivory/80 uppercase border-b border-ivory/30 hover:text-gold-soft hover:border-gold-soft">
                Our Story
              </Link>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-28 md:px-10">
        <div className="mb-14 flex items-end justify-between gap-6">
          ...
          <Link to="/collections" className="hidden md:inline-flex text-xs tracking-[0.25em] uppercase text-foreground/70 hover:text-gold border-b border-foreground/30 hover:border-gold pb-1">
            View All
          </Link>
        </div>
      ...
      <section className="relative mt-12 overflow-hidden">
        <div className="grid lg:grid-cols-2">
          <div className="relative h-[60vh] lg:h-auto">
            <img src={collection} alt="Curated jewelry flatlay" loading="lazy" className="absolute inset-0 h-full w-full object-cover" />
          </div>
          <div className="bg-secondary px-6 py-20 md:px-16 lg:py-32 flex items-center">
            <div className="max-w-md">
              ...
              <Link to="/about" className="mt-10 inline-flex items-center gap-3 text-xs tracking-[0.25em] uppercase text-onyx border-b border-onyx pb-2 hover:text-gold hover:border-gold">
                Meet the Makers →
              </Link>
            </div>
          </div>
